...
import 'ResturantMapView.dart';

class ResturantList extends StatefulWidget {
  ResturantList({Key key}) : super(key: key);
...
class _ResturantListState extends State<ResturantList>
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        if (fromBottom == 100) {
                          ...
                          setState(() => fromBottom = 0);
                        } else {
                          setState(() => fromBottom = 100);
  ...
  StatelessWidget getBlurWidget() => (animation.value > 0)
      ? GestureDetector(
          onTap: () {
            print('TAP OUT-SIDE');
            animationController.reverse();
...
Padding getFilterWidgetIcon(IconData icon) => Padding(
